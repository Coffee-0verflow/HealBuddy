    ...
    <div className="max-w-2xl mx-auto space-y-5 pb-12 pt-4 px-2">
      ...
      <div className={`p-6 rounded-2xl border shadow-md relative overflow-hidden ${
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className={`text-[10px] font-black uppercase tracking-widest ${isEmergency ? 'text-red-600 dark:text-red-400' : 'text-teal-600 dark:text-teal-400'}`}>
      ...
      <div className="bg-white dark:bg-slate-800 p-5 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm space-y-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="text-base font-bold text-slate-800 dark:text-slate-100">Find Nearby Hospitals</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Locate <strong className="text-teal-600 dark:text-teal-400">{doctorType}</strong> facilities near you.</p>
          </div>
        </div>
        <button
